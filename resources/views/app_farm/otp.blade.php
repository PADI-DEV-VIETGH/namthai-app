            ...
            <div class="page-content">
                <div class="main-body-content member-page">
                    <div class="member-title-table">
                        <div class="logo text-center"><img src="assets/images/logo.png" /></div>
                        ...
                        <div class="full border-full pad-20-30 mrb-40">
                            <div class="full mrb-10">
                                ...
                                <div class="col-md-12"><span class="text-note">Một mã OTP đã được gửi tới
                                        Email của bạn:</span>
                                    <input class="form-control" type="text" placeholder="Nguyễn Văn A" />
                                </div>
                                <div class="col-md-12 text-right"><a class="text-link-otp" href="#">Lấy lại mã OTP
                                        ?</a></div>
                            </div>
