$(function() {
	...
	$('#product').DataTable({
		language: {
			searchPlaceholder: 'Tìm kiếm theo tên sản phẩm, mã sản phẩm, danh mục...',
			sSearch: '',
			lengthMenu: '_MENU_ items/page',
		}
	});
  $('#product_mk').DataTable({
    language: {
      searchPlaceholder: 'Tìm kiếm theo tên sản phẩm, mã sản phẩm, danh mục...',
      sSearch: '',
      lengthMenu: '_MENU_ items/page',
...
$('#plan').DataTable({
    language: {
      searchPlaceholder: 'Tìm kiếm theo tên kế hoạch, mã kế hoạch, người tạo...',
      sSearch: '',
      lengthMenu: '_MENU_ items/page',
    }
  });
