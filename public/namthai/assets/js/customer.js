                ...
                filesArr.forEach(function (f, index) {
                    ...
                    if (imgArray.length > maxLength) {
                        ...
                        if (len > maxLength) {
                            ...
                            var reader = new FileReader();
                            reader.onload = function (e) {
                                var html = "<div class='upload-images_input'><div class='upload__img-boxs'><div style='background-image: url(" + e.target.result + ")' data-number='" + $(".upload__img-close").length + "' data-file='" + f.name + "' class='img-bg'><div class='upload__img-close'></div></div><div class='content__input'><input class='form-control' type='text' placeholder='comment'/></div></div></div>";
                                imgWrap.append(html);
                                iterator++;
                            }
                            reader.readAsDataURL(f);
